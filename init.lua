...
vim.keymap.set('n', '<leader>wp', 'gT', { desc = '[P]revious tab' })
vim.keymap.set('n', '<leader>wn', 'gt', { desc = '[N]ext tab' })
vim.keymap.set('n', '<leader>wt', ':<C-u>tab split<cr>', { desc = 'New [T]ab' })
vim.keymap.set('n', '<leader>wv', ':<C-u>vsplit<cr>', { desc = '[V]ertical split (|)' })
vim.keymap.set('n', '<leader>wh', ':<C-u>split<cr>', { desc = '[H]orizontal split (-)' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>ld', require('telescope.builtin').lsp_definitions, '[L]anguage [D]efinition')

          -- Find references for the word under your cursor.
          map('<leader>lu', require('telescope.builtin').lsp_references, '[L]anguage [U]sages (references)')

          -- Jump to the implementation of the word under your cursor.
          --  Useful when your language has ways of declaring types without an actual implementation.
          map('<leader>li', require('telescope.builtin').lsp_implementations, '[L]anguage [I]mplementation')

          -- Jump to the type of the word under your cursor.
          --  Useful when you're not sure what type a variable is and you want to see
          --  the definition of its *type*, not where it was *defined*.
          map('<leader>lt', require('telescope.builtin').lsp_type_definitions, '[L]anguage [T]ype Definition')
          ...
          map('<leader>la', vim.lsp.buf.code_action, '[L]anguage [A]ction')
          ...
          map('<leader>lD', vim.lsp.buf.declaration, '[L]anguage [D]eclaration')
          ...
          if client and client.server_capabilities.inlayHintProvider and vim.lsp.inlay_hint then
            ...
            end, 'Toggle [L]anguage Inlay [H]ints')
          end
        end,
      })
      ...
      -- gdscript doesn't have a tool to install, it runs an LSP server when you launch the godot engine itself
      require('lspconfig').gdscript.setup {}

      require('mason-lspconfig').setup {
        handlers = {
          function(server_name)
            -- disabling tsserver on my work machine
